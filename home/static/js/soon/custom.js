...
(function($) {
    ...
    **/
    var launch = new Date(2018, 06, 5, 11, 00);
    /**
    * The script
    **/
    var message = $('#message');
    ...
    function setDate(){
        ...
        if( launch < now ){
            ...
            message.html('by PapiHack, the itDev...');
        }
        else{
            var s = -now.getTimezoneOffset()*60 + (launch.getTime() - now.getTime())/1000;
            var d = Math.floor(s/86400);
            days.html('<h1>'+d+'</h1>Day'+(d>1?'s':''),'</p>');
            s -= d*86400;
            ...
            message.html('Mon site est en construction, Patience ! By PapiHack, the itDev...');
        }
    }
})(jQuery);
/******************************************************************************************************************************
